...
func New(cfg Config) (Provider, error) {
	...
	case "anthropic":
		if cfg.Model == "" || cfg.apiKey == "" {
			return nil, errors.New("BENEFITS_AI_MODEL and BENEFITS_AI_API_KEY are required when BENEFITS_AI_PROVIDER is anthropic")
		}
...
// (https://api.anthropic.com/v1/messages). It exists because Help The Hive
// runs on Claude: the provider kind "anthropic" accepts the Anthropic API key
// and model directly instead of going through an OpenAI-compatible shim.
