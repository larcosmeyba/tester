...
// snapshot can be chosen instead through BENEFITS_AI_MODEL.
// https://docs.anthropic.com/docs/en/models/haiku-4-5/overview
const (
	anthropicAPIVersion = "2023-06-01"
	// defaultAnthropicBaseURL is used when BENEFITS_AI_BASE_URL is unset. An
	// explicit value always wins.
	defaultAnthropicBaseURL = "https://api.anthropic.com"
	// defaultAnthropicModel is used when BENEFITS_AI_MODEL is unset.
...
func New(cfg Config) (Provider, error) {
	...
	case "anthropic":
		if cfg.apiKey == "" {
			return nil, errors.New("BENEFITS_AI_API_KEY is required when BENEFITS_AI_PROVIDER is anthropic")
		}
		if cfg.BaseURL == "" {
